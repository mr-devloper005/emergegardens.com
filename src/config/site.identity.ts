export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'emergegardens',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Emergegardens',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'emergegardens.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://emergegardens.com',
